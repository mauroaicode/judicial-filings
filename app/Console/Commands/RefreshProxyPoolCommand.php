...
class RefreshProxyPoolCommand extends Command
{
    ...
    protected $description = 'Verifica que el proxy residencial rotativo de Webshare funciona contra Rama Judicial';
    ...
    public function handle(): int
    {
        ...
        // Step 2: test against Rama Judicial
        ...
        $this->line("2. Probando contra Rama Judicial (radicado: {$radicado})...");
