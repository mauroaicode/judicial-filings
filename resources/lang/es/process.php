...
return [
    ...
    'max_active_processes_reached' => 'La organización alcanzó el límite de :limit radicados activos (actualmente :current). Desactive algún radicado o solicite ampliar el cupo.',
    'max_active_processes_import_skipped' => 'No importado: la organización alcanzó el límite de :limit radicados activos (actualmente :current).',
    'import_quota_limit_blocked' => 'Ningún radicado pudo importarse porque la organización alcanzó el límite de radicados activos.',
    ...
    'moved_to_trash' => 'El proceso se envió a la papelera.',
    'trash_nothing_trashed' => 'Ningún proceso se pudo enviar a la papelera. Verifique que pertenezcan a la organización y que no estén ya en papelera.',
    ...
    'manual_registration_details_required' => 'Este radicado no está disponible en consulta automática. Completa la información del proceso para enviarlo a revisión con tu asesor.',
    'manual_registration_requested' => 'Recibimos tu solicitud. Lo dejamos en revisión con tu asesor; te confirmaremos cuando quede registrado.',
    'manual_registration_plaintiffs_required' => 'Debes agregar al menos un demandante.',
    'manual_registration_defendants_required' => 'Debes agregar al menos un demandado.',
    'manual_registration_subject_name_required' => 'El nombre del sujeto es obligatorio.',
    'manual_registration_request_not_found' => 'Solicitud de alta manual no encontrada.',
    'manual_registration_already_resolved' => 'Esta solicitud de alta manual ya fue resuelta.',
    'manual_registration_invalid_status_transition' => 'Estado de solicitud de alta manual no válido.',
    ...
    'manual_registration_completed_subject' => 'Tu radicado :number ya está registrado',
    'manual_registration_completed_title' => 'Radicado registrado por tu asesor',
    'manual_registration_completed_intro' => 'La solicitud de alta manual fue completada. Ya puedes consultar el proceso en NotiJudicial.',
    'manual_registration_completed_alert' => 'El radicado :number quedó registrado y disponible en tu organización.',
    'manual_registration_completed_what_title' => 'Qué sigue',
    'manual_registration_completed_what_body' => 'Revisa la información general y las actuaciones del proceso. Si faltan datos, contacta a tu asesor.',
    'manual_registration_completed_description' => 'El radicado :number ya fue registrado por tu asesor y está disponible para consulta.',
    ...
    'organizations_attached_successfully' => 'Organizaciones interesadas actualizadas exitosamente.',
    'updated_successfully' => 'Información del proceso actualizada exitosamente.',
    'action_updated_successfully' => 'Fechas de la actuación actualizadas exitosamente.',
    'action_not_found' => 'Actuación no encontrada.',
    'admin_update_requires_at_least_one_field' => 'Debe enviar al menos un campo para actualizar.',
    'term_end_before_start' => 'La fecha de finalización del término no puede ser anterior a la fecha de inicio.',
