...
return [
    ...
    'urgency_email_task_description' => 'Descripción',
    'urgency_email_process_number' => 'Radicado',
    'urgency_email_days_elapsed' => 'Días desde el vencimiento',
    ...
    'urgency_email_headline_alert_1' => 'Su tarea lleva 10 días vencida',
    'urgency_email_headline_alert_2' => 'Su tarea lleva 15 días vencida',
    'urgency_email_headline_critical' => 'Su tarea superó 30 días desde el vencimiento',
    'urgency_email_headline_default' => 'Tiene una tarea pendiente que requiere atención',

    'urgency_email_body_alert_1' => 'La tarea «:title» lleva :days días vencida y aún no ha sido marcada como cumplida. Le recomendamos revisarla pronto.',
    'urgency_email_body_alert_2' => 'Han transcurrido :days días desde el vencimiento de «:title» y sigue pendiente. Es importante dar seguimiento para evitar retrasos.',
    'urgency_email_body_critical' => 'La tarea «:title» lleva :days días vencida, superando el límite máximo aceptable de un mes. Requiere acción inmediata.',
    'urgency_email_body_default' => 'La tarea «:title» lleva :days días vencida.',
    ...
    'urgency_internal_description_alert_1' => '«:title» (Radicado: :process) lleva :days días vencida sin cumplirse.',
    'urgency_internal_description_alert_2' => '«:title» (Radicado: :process) acumula :days días desde el vencimiento.',
    'urgency_internal_description_critical' => '«:title» (Radicado: :process) superó los 30 días desde el vencimiento (:days días).',
