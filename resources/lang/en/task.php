...
return [
    ...
    'urgency_email_days_elapsed' => 'Days elapsed',
    ...
    'urgency_email_headline_alert_1' => 'Your task has been pending for 10 days',
    'urgency_email_headline_alert_2' => 'Your task has been uncompleted for 15 days',
    'urgency_email_headline_critical' => 'Your task exceeded the 30-day limit',
    'urgency_email_headline_default' => 'You have a pending task that requires attention',

    'urgency_email_body_alert_1' => 'Task «:title» has been open for :days days and has not been marked as completed. We recommend reviewing it soon.',
    'urgency_email_body_alert_2' => ':days days have passed since «:title» was created and it is still pending. Follow up to avoid delays.',
    'urgency_email_body_critical' => 'Task «:title» has been pending for :days days, exceeding the one-month limit. Immediate action is required.',
    'urgency_email_body_default' => 'Task «:title» has been pending for :days days.',
    ...
    'urgency_internal_description_alert_1' => '«:title» (Filing: :process) has been uncompleted for :days days.',
    'urgency_internal_description_alert_2' => '«:title» (Filing: :process) has been pending for :days days.',
    'urgency_internal_description_critical' => '«:title» (Filing: :process) exceeded 30 days pending (:days days).',
