...
return [
    ...
    'max_active_processes_reached' => 'The organization reached its limit of :limit active filings (currently :current). Deactivate a filing or request a higher quota.',
    'max_active_processes_import_skipped' => 'Not imported: the organization reached its limit of :limit active filings (currently :current).',
    'import_quota_limit_blocked' => 'No filings could be imported because the organization reached its active filings limit.',
    ...
    'moved_to_trash' => 'The process was moved to trash.',
    'trash_nothing_trashed' => 'No processes could be moved to trash. Check that they belong to the organization and are not already in trash.',
    ...
    'manual_registration_details_required' => 'This case number is not available via automatic lookup. Complete the process details to send it for review with your advisor.',
    'manual_registration_requested' => 'We received your request. It is under review with your advisor; we will confirm once it is registered.',
    'manual_registration_plaintiffs_required' => 'Add at least one plaintiff.',
    'manual_registration_defendants_required' => 'Add at least one defendant.',
    'manual_registration_subject_name_required' => 'The subject name is required.',
    'manual_registration_request_not_found' => 'Manual registration request not found.',
    'manual_registration_already_resolved' => 'This manual registration request was already resolved.',
    'manual_registration_invalid_status_transition' => 'Invalid manual registration request status.',
    ...
    'manual_registration_completed_subject' => 'Your filing :number is now registered',
    'manual_registration_completed_title' => 'Filing registered by your advisor',
    'manual_registration_completed_intro' => 'Your manual registration request was completed. You can now view the process in NotiJudicial.',
    'manual_registration_completed_alert' => 'Filing :number is now registered and available in your organization.',
    'manual_registration_completed_what_title' => 'What is next',
    'manual_registration_completed_what_body' => 'Review the process general information and actions. If anything is missing, contact your advisor.',
    'manual_registration_completed_description' => 'Filing :number was registered by your advisor and is now available.',
    ...
    'organizations_attached_successfully' => 'Interested organizations updated successfully.',
    'updated_successfully' => 'Process information updated successfully.',
    'action_updated_successfully' => 'Action dates updated successfully.',
    'action_not_found' => 'Action not found.',
    'admin_update_requires_at_least_one_field' => 'Send at least one field to update.',
    'term_end_before_start' => 'The term end date cannot be earlier than the term start date.',
