...
//        }
//
//        return (new GetFilingNumbersToProcessUseCase())->getAllUniqueProcessNumbersWithActiveOrganizations();
//    }
//
//    /**
//     * Obtiene los radicados únicos de una organización específica
//     */
//    protected function getFilingsByOrganization(string $organizationSlug): Collection {
//
...
//     */
//    protected function syncProcessWithAPI(string $filingNumber): void
//    {
//        try {
...
//                $unifiedProcess = $this->getUnifiedProcessData($processBasic, $filingNumber);
//
//                if ($unifiedProcess) {
//                    if (count($processes) > 1) {
//                        $this->handleMultipleInstances($filingNumber, $unifiedProcess);
//                    } else {
//                        $this->handleSingleProcess($filingNumber, $unifiedProcess);
//                    }
//                }
//            }
//
...
//     */
//    protected function getUnifiedProcessData(array $processBasic, string $filingNumber): ?array
//    {
//        try {
//
//            $responseProcessDetail = $this->judicialService->fetchDetailProcess($processBasic['idProceso']);
//
...
//     */
//    protected function handleMultipleInstances(string $filingNumber, array $unifiedProcess): void
//    {
...
//        $this->createOrUpdateProcessInstance($unifiedProcess);
//
//        // Obtener el proceso recién creado/actualizado
//        $process = $this->processRepository->findByProcessId($unifiedProcess['process_id']);
//
//        if ($process) {
...
//     */
//    protected function handleSingleProcess(string $filingNumber, array $unifiedProcess): void
//    {
...
//     */
//    protected function createOrUpdateProcessInstance(array $unifiedProcess): void
//    {
...
//        $process = $this->processRepository->createOrUpdateProcess($processData);
//
...
//     */
//    protected function syncProcessActions(array $processes): void
//    {
