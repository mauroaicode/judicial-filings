...
class ProcessActionResource extends Resource
{
    ...
    public function __construct(
        ...
        public ?string $action_date_iso,
        public string $action,
        public ?string $annotation,
        public string $term_start_date,
        public ?string $term_start_date_iso,
        public string $term_end_date,
        public ?string $term_end_date_iso,
        public string $registration_date,
        public ?string $registration_date_iso,
    ...
    public static function fromModel(ProcessAction $action, int $index = 0): self
    {
        ...
        return new self(
            ...
            action_date_iso: DateFormatHelper::formatIsoDate($action->action_date),
            action: $action->action,
            annotation: $action->annotation,
            term_start_date: $action->start_date ? DateFormatHelper::formatDate($action->start_date) : '-',
            term_start_date_iso: DateFormatHelper::formatIsoDate($action->start_date),
            term_end_date: $action->end_date ? DateFormatHelper::formatDate($action->end_date) : '-',
            term_end_date_iso: DateFormatHelper::formatIsoDate($action->end_date),
            registration_date: DateFormatHelper::formatDate($action->registration_date),
            registration_date_iso: DateFormatHelper::formatIsoDate($action->registration_date),
