...
/**
 * La API del Portal Judicial respondió HTTP 200 pero con array de procesos vacío.
 *
 * Portal Judicial puede devolver vacío de forma transitoria bajo carga (falso vacío),
