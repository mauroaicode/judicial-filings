...
class SmsTaskDueDateReminderChannelDriver implements TaskDueDateReminderChannelDriverInterface
{
    public function send(TaskDueDateReminderAlert $alert, OrganizationNotificationChannel $channel): void
    {
        ...
        Log::channel(config('tasks.log_channel', 'stack'))->info('Task due-date reminder SMS (placeholder)', [
    ...
    {
        return __('task.due_reminder_sms_message', [
